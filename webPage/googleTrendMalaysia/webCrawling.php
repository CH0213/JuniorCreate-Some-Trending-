        ...
        $data = file_get_contents("https://trends.google.co.kr/trends/trendingsearches/daily/rss?geo=MY");
        ...
        $count = 1;
         ...
         $google_link = [];
         $kkk = [];
         $page3 = file_get_html('https://trends.google.co.kr/trends/trendingsearches/daily/rss?geo=MY');
        echo "<thead> <td colspan ='2'> 말레이시아 실시간 검색어 </td> </thead>";
        echo "<tbody class='table-hover'>";
         ...
         $count = 1;
         $page3_1 = file_get_html('https://trends.google.co.kr/trends/trendingsearches/daily/rss?geo=MY');
